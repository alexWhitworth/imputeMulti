...
#   
#   
#   # 03. Run 30 iterations, make sure log-lik is increasing
#   #------------------------------------
#   iter10 <- multinomial_data_aug(x_y= x_y, z_Os_y= z_Os_y, enum_comp= enum_comp, 
#                           n_obs= nrow(dat), conj_prior= "none", 
#                           verbose= FALSE, burnin= 10) 
#   iter20 <- multinomial_data_aug(x_y= x_y, z_Os_y= z_Os_y, enum_comp= enum_comp, 
#                           n_obs= nrow(dat), conj_prior= "none", 
#                           verbose= FALSE, burnin= 20) 
#   iter30 <- multinomial_data_aug(x_y= x_y, z_Os_y= z_Os_y, enum_comp= enum_comp, 
#                                  n_obs= nrow(dat), conj_prior= "none", 
#                                  verbose= FALSE, burnin= 30) 
#   
#   # tests:
#   expect_less_than(iter10@mle_log_lik, iter20@mle_log_lik)
#   expect_less_than(iter10@mle_log_lik, iter30@mle_log_lik)
#   expect_less_than(iter20@mle_log_lik, iter30@mle_log_lik)
